...
from app.repository.practicce.practice_api_openai_repository import PracticeApiOpenAiRepository
...
def get_english_api_repository(llm : Annotated[BaseChatModel,Depends(get_chat_prompt_template)]) -> PracticeApiRepository:
